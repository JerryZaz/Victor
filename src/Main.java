...
public class Main
{
    public static void main(String[] args)
    {
        ...
        Agent redPlayer = new Victor(game, true); // create the red player, any subclass of Agent
        Agent yellowPlayer = new Vicky(game, false); // create the yellow player, any subclass of Agent
